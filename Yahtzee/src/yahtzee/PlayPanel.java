...
public class PlayPanel extends JPanel {
	...
	public PlayPanel() {
		...
		gridBagLayout.columnWidths = new int[]{10, 10, 10, 10, 10, 10, 10, 10, 10, 10};
		...
		gbc_chckbxHoldDieOne.gridy = 4;
		add(chckbxHoldDieOne, gbc_chckbxHoldDieOne);

		JCheckBox chckbxHoldDieTwo = new JCheckBox("HoldDieOne");
		...
		gbc_chckbxHoldDieTwo.gridy = 4;
		add(chckbxHoldDieTwo, gbc_chckbxHoldDieTwo);
		
		JCheckBox chckbxHoldDieThree = new JCheckBox("HoldDieOne");
		...
		gbc_chckbxHoldDieThree.gridy = 4;
		add(chckbxHoldDieThree, gbc_chckbxHoldDieThree);
		
		JCheckBox chckbxHoldDieFour = new JCheckBox("HoldDieOne");
		...
		gbc_chckbxHoldDieFour.gridy = 4;
		add(chckbxHoldDieFour, gbc_chckbxHoldDieFour);
		
		JCheckBox chckbxHoldDieFive = new JCheckBox("HoldDieOne");
		...
		gbc_lblSmallStraightScore.gridy = 6;
		...
		gbc_lblLargeStraightScore.gridy = 7;
